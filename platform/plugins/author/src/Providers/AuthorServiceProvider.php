...
class AuthorServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        SlugHelper::registering(function (): void {
            SlugHelper::registerModule(Author::class, trans('plugins/author::author.name'));
                    ...
                    return $form
                        ...
                        ->addAfter(
                            ...
                            SelectFieldOption::make()
                                ->label(trans('plugins/author::author.author'))
                                ->choices(
                                    Author::query()
                                        ->wherePublished()
                                        ->pluck('name', 'id')
                                ...
                                ->required()
                                ->emptyValue(trans('plugins/author::author.select_author'))
                                ->toArray()
                        );
                }, 127);
